...
CLI(net)
##################################################################################################################
#################################### for the initial test, the next comment are not necessary####################
##################################################################################################################
...
#	time.sleep(24/3.0)
#	if add_a_link:
#		print ('adding a new link...', net.addLink( h1, s3, cls=TCLink , bw=50, delay='1ms', max_queue_size=max_queue_size ))
#		s3.attach('s3-eth5')
...
#    h1.cmd('iperf -t '+str(24)+' -i 0.5 -c '+h2.IP()+' > iperf_bandwith_client_log.txt &') # cliens
#	
#	under_testing()
#	
